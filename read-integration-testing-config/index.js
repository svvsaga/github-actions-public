...
exports.readIntTestingConfig = void 0;
const core = __importStar(__nccwpck_require__(186));
const fs = __importStar(__nccwpck_require__(147));
function readIntTestingConfig(projectDir, configFileName) {
...
exports.readIntTestingConfig = readIntTestingConfig;
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const projectRoot = core.getInput('cwd');
            const res = yield readIntTestingConfig(projectRoot, 'inttest.config.json');
            if (!res) {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(454);
